  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="py-16 sm:py-20 bg-gradient-to-br from-purple-50 via-pink-50 to-purple-100 dark:from-purple-950 dark:via-pink-950 dark:to-purple-900 relative overflow-hidden">
          {/* Background Pattern */}
          ...
          <div className="container-custom relative z-10">
            ...
            <div className="max-w-4xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl border border-white/30 dark:border-gray-700/30 shadow-soft dark:shadow-soft p-8 sm:p10">
                <div className="relative">
                  <input
                    type="text"
                    placeholder="Search for products, categories, or brands..."
                    className="w-full px-8 py-5 pl-16 bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm border-2 border-purple-200 dark:border-purple-600 rounded-2xl focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 dark:focus:border-purple-400 transition-all duration-300 text-lg shadow-soft dark:shadow-soft hover:border-purple-300 dark:hover:border-purple-500 focus:shadow-glow text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400"
                  />
                  ...
                  <button className="absolute right-3 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-purple-500 to-pink-500 dark:from-purple-600 dark:to-pink-600 text-white px-8 py-3 rounded-xl font-semibold hover:from-purple-600 hover:to-pink-600 dark:hover:from-purple-700 dark:hover:to-pink-700 transition-all duration-300 transform hover:scale-105 shadow-glow hover:shadow-glow-accent">
                    Search
                  </button>
                </div>
                ...
                <div className="mt-6 flex flex-wrap justify-center gap-3">
                  {['Skincare', 'Makeup', 'Hair Care', 'Perfume', 'Body Care'].map((tag, index) => (
                    <button
                      key={tag}
                      className="px-4 py-2 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 rounded-full text-sm font-medium hover:bg-purple-200 dark:hover:bg-purple-800/50 hover:scale-105 transition-all duration-300"
