...
export default function Footer() {
  return (
    <footer className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden">
      ...
      <div className="relative z-10 bg-gradient-to-r from-primary-500/20 via-accent-500/20 to-primary-500/20 backdrop-blur-sm border-y border-white/10">
        <div className="container-custom py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {trustFeatures.map((feature, index) => (
              ...
              >
                <div className="w-12 h-12 bg-gradient-to-br from-primary-500 to-accent-500 rounded-xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300 shadow-glow">
                  <feature.icon className="w-6 h-6 text-white" />
                </div>
                <h4 className="font-semibold text-sm mb-1 text-white group-hover:text-primary-300 transition-colors">
                  {feature.title}
                </h4>
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="flex items-center space-x-3 mb-6">
              <div className="relative">
                <div className="w-12 h-12 bg-gradient-to-br from-primary-500 via-accent-500 to-primary-600 rounded-2xl flex items-center justify-center shadow-glow">
                  <span className="text-white font-bold text-xl">SR</span>
                </div>
                <div className="absolute -inset-1 bg-gradient-to-br from-primary-500 to-accent-500 rounded-2xl blur opacity-30 animate-pulse"></div>
              </div>
              <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3 group">
                <div className="w-10 h-10 bg-gradient-to-br from-primary-500/20 to-accent-500/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <PhoneIcon className="w-5 h-5 text-primary-400" />
                </div>
                <div>
                  <p className="text-xs text-gray-400">Phone</p>
                  <span className="text-sm text-gray-200 group-hover:text-primary-300 transition-colors">+8801919025785</span>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 group">
                ...
                <div>
                  ...
                  <span className="text-sm text-gray-200 group-hover:text-primary-300 transition-colors">support@shohanis-reflection.com</span>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 group">
                ...
                <div>
                  ...
                  <span className="text-sm text-gray-200 group-hover:text-primary-300 transition-colors">Dhaka, Bangladesh</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <ul className="space-y-3">
              {footerLinks.information.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-gray-300 hover:text-primary-400 transition-all duration-300 text-sm group flex items-center"
                  >
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:ring-4 focus:ring-primary-500/20 focus:border-primary-500 transition-all duration-300 backdrop-blur-sm"
              />
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-8 text-sm text-gray-400 text-center">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Link 
                  ...
                  className="text-primary-400 hover:text-primary-300 transition-colors font-medium hover:underline" 
                  target='_blank'
                >
                  Asib
                </Link>
