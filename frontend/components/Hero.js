...
export default function Hero() {
  ...
  return (
    <section className="relative h-[500px] sm:h-[600px] md:h-[700px] lg:h-[800px] overflow-hidden bg-gradient-to-br from-purple-50 via-pink-50 to-purple-100 dark:from-slate-900 dark:via-purple-950 dark:to-indigo-950">
      {/* Background Pattern */}
      ...
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="absolute inset-0">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-slate-900/60 via-slate-800/40 to-slate-700/20" />
